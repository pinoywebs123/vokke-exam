                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                     ...
                     <div class="pcoded-content">
                        ...
                        @endif
                      <form method="POST" action="{{route('update_kangaroo')}}">
                        @csrf
                        <input type="hidden" name="kangaroo_id" value="{{Request::segment(2)}}">
                      <div class="container">
                          <div class="form-group">
                      <label for="email">Name:</label>
                      <input type="text" class="form-control"  id="editname" required maxlength="30" value="{{$find_kangaroo->name}}" name="name">
                    </div>

                    <div class="form-group">
                      <label for="email">Nickname:</label>
                      <input type="text" class="form-control"  id="editnickname" max="30" value="{{$find_kangaroo->nickname}}" name="nickname">
                    </div>

                    <div class="form-group">
                      <label for="email">Weight grams:</label>
                      <input type="number" class="form-control"  id="editweight" step="0.1" required value="{{$find_kangaroo->weight}}" name="weight">
                    </div>

                    <div class="form-group">
                      <label for="email">Height inch:</label>
                      <input type="number" class="form-control"  id="editheight" step="0.1" required value="{{$find_kangaroo->height}}" name="height">
                    </div>

                    <div class="form-group">
                      <label for="email">Gender:</label>
                      <select class="form-control" id="editgender" required name="gender">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  id="editcolor" max="30" value="{{$find_kangaroo->color}}" name="color">
                    </div>

                    <div class="form-group">
                      <label for="email">Friendliness:</label>
                      <select class="form-control" id="editfriendliness" required name="friendliness">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control"  id="editdob" max="30" value="{{$find_kangaroo->dob}}" name="dob">
                    </div>
